           ...
           <div className="userbox ">
              ...
              <div className="container">
                 ...
                 <div className="info_box">
                       <div className="nameC"> <h1>{userInfo.name}</h1> </div>
                       ...
                       <a className="follo" href="#" onClick={() => { 
                         ...
                         setshowFollowings(showFollowings ? false : false) } }>{userInfo.followers} Followers  </a>
       
                       <a className="follo" href="#" onClick={() => { 
                         setshowFollowings(showFollowings ? false : true); 
                         setshowFollowers(showFollowers ? false : false)} }>   {userInfo.following} Following
                        </a>
